...
CREATE TABLE IF NOT EXISTS user_metadata (
  ...
  workroom TEXT,
  user_role TEXT CHECK (user_role IN ('GM', 'PC', 'Corporate', 'President', 'Finance', 'IT', 'Other')),
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE user_metadata ADD COLUMN user_role TEXT CHECK (user_role IN ('GM', 'PC', 'Corporate', 'President', 'Finance', 'IT', 'Other'));
  END IF;
END $$;
