...
3. It should be something like:
   - `pod.floorinteriorservices.com` (this is your production domain)
...
### 1. Intuit Dashboard
- Add redirect URI: `https://pod.floorinteriorservices.com/api/quickbooks/callback`
- Save
...
After setup:
1. Always test on: `https://pod.floorinteriorservices.com/finance-hub`
